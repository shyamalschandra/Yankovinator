...
**Current release:** [v1.06.0](https://github.com/shyamalschandra/Yankovinator/releases/tag/v1.06.0)
...
```bash
git tag -a v1.06.0 -m "Release version 1.06.0"
git push origin v1.06.0
```
