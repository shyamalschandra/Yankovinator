...
**Current release:** [v1.03.1](https://github.com/shyamalschandra/Yankovinator/releases/tag/v1.03.1)
...
```bash
git tag -a v1.03.1 -m "Release version 1.03.1"
...
Actions → **Build and Release** → **Run workflow** → enter a version tag (for example `v1.03.1`).
