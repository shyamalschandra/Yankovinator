...
**Current release:** [v1.04.7](https://github.com/shyamalschandra/Yankovinator/releases/tag/v1.04.7)
...
```bash
git tag -a v1.04.7 -m "Release version 1.04.7"
...
Actions → **Build and Release** → **Run workflow** → enter a version tag (for example `v1.04.7`).
