...
**Current release:** [v1.04.5](https://github.com/shyamalschandra/Yankovinator/releases/tag/v1.04.5)
...
```bash
git tag -a v1.04.5 -m "Release version 1.04.5"
git push origin v1.04.5
```
...
Actions → **Build and Release** → **Run workflow** → enter a version tag (for example `v1.04.5`).
