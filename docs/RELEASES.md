...
**Current release:** [v1.04.8](https://github.com/shyamalschandra/Yankovinator/releases/tag/v1.04.8)
...
curl -L -o yankovinator-universal.tar.gz \
  https://github.com/shyamalschandra/Yankovinator/releases/download/v1.04.8/yankovinator-universal.tar.gz
...
```bash
git tag -a v1.04.8 -m "Release version 1.04.8"
...
Actions → **Build and Release** → **Run workflow** → enter a version tag (for example `v1.04.8`).
